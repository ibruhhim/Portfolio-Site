...
const FooterContact: React.FC = () => {
  ...
  return (
    <div>
      <h3 className="font-display text-lg font-bold mb-4 text-amber-300">Connect</h3>
      <div className="flex flex-col gap-3">
        {contacts.map((contact) => (
          <a
            ...
            className="flex items-center text-gray-300 hover:text-amber-300 transition-colors text-base md:text-sm font-medium"
          >
            {contact.icon}
            {contact.label}
          </a>
