  ...
  return (
    <div className='bg-gradient-to-br from-gray-50 to-white flex flex-col md:flex-row justify-center items-center w-full py-20 px-6 md:px-12 gap-12 mb-36'>
      <div className='flex-1 max-w-2xl'>
        <blockquote className="relative text-xl md:text-2xl font-light text-gray-800 leading-relaxed">
          <div className="flex items-start gap-4">
            <span className="text-5xl md:text-6xl font-bold text-emerald-600 leading-none mt-2">&ldquo;</span>
      ...
      <div className='flex-shrink-0'>
        <div className='w-56 h-56 md:w-72 md:h-72 shadow-2xl border-4 border-emerald-500/30 rounded-full overflow-hidden flex items-center justify-center bg-emerald-50 p-1'>
